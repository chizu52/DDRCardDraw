/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 28d7f79f2e840472dc8c543c44c7d1c8)
// Runtime types generated with workerd@1.20260820.1 2026-08-01 nodejs_compat
interface __BaseEnv_Env {
	Main: DurableObjectNamespace<import("./src/party/server").Main>;
	CaptureBridge: DurableObjectNamespace<import("./src/party/server").CaptureBridge>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/party/server");
		durableNamespaces: "Main" | "CaptureBridge";
	}
